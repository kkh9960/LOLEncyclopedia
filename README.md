...
|  팁 목록 조회  |  GET   |         /          |                                                                                                                                                                             | 팁리스트      |
|   팁 작성    |  POST  |        /lol        | {'num': count, 'file' : f'{filename}.{extension}', 'title' : title_receive,<br> 'name' : name_receive, 'postion':postion_receive, 'star':star_receive, 'desc':desc_receive} | 작성 팁 데이터  |
